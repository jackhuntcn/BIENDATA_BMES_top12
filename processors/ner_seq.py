...
class BienProcessor(DataProcessor):
    """Processor for the chinese ner data set."""
    ...
    def get_labels(self):
        """See base class."""
        return ['O', 'B-RIV', 'I-RIV', 'B-LAK', 'I-LAK', 'B-LOC', 'I-LOC', 'B-TER',
       'I-TER', 'B-RES', 'I-RES', 'B-OTH', 'I-OTH', 'B-HYD', 'I-HYD',
       'B-DAM', 'I-DAM', 'B-ORG', 'I-ORG', 'B-PER', 'I-PER']
